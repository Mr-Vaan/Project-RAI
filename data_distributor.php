  ...
  <tbody>
    ...
    foreach($data_distributor as $row) {
      ...
      <tr>
        ...
        <td><?php echo"<a href='data_distributor.php?&edit=update&&id=$row[kd_distributor]' class='btn btn-sm btn-success'> Edit </a>";?> <a href = "<?php echo "proses_distributor.php?aksi=delete&&id=$row[kd_distributor]"; ?>" class = "btn btn-m btn-warning" onclick ="javascript: return confirm('Apakah Anda yakin ingin menghapus data ini ?')"> Delete</a></td>
      </tr>
      <?php
    }
    ?>
